...
import 'package:ju/app/modules/bmap/common/search_btn.dart';
import 'package:ju/app/modules/bmap/model/search_textfield.dart';
                    ...
                    child: Row(
                      children: [
                        ...
                        SearchTextField(
                          ...
                          title: "起点：",
                          width: (screenSize.width - 100 - 60 - 16),
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: Row(
                      children: [
                        ...
                        SearchTextField(
                          ...
                          title: "终点：",
                          width: (screenSize.width - 90 - 60 - 20),
                        ),
                      ],
                    ),
                  ),
